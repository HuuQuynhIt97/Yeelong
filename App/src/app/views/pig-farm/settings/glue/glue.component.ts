...
import { Glue } from 'src/app/_core/_model/setting/glue';

@Component({
  selector: 'app-glue',
  templateUrl: './glue.component.html',
  styleUrls: ['./glue.component.css']
})
export class GlueComponent extends BaseComponent implements OnInit, OnDestroy {
